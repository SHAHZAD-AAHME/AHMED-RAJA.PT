...
PPPPPPPPPP                           KKKKKKKKK    KKKKKKK
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mafia-boy-Sajjad\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/SHAHZADA-AHMED \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://m.me/Tera.Bap.Ka.Id.Hain\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/SHAHZADA-AHMED/approval.txt/blob/main/approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://m.me/Tera.Bap.Ka.Id.Hain ")
...
def notice():
	...
	os.system("xdg-open https://wa.me/Tera.Bap.Ka.Id.Hain?app=fbl")
	runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Approval Neyar Jonno Messenger A key Dao ")
	os.system("xdg-open https://wa.me/Tera.Bap.Ka.Id.Hain?text=")
	subprocess.check_output(["am", "start", "https://wa.me/+8801840215106?text="])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/SHAHZADA-AHMED/approval.txt/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      : -- \n")
		print(" [ Sosial Medi  ] -- \n")
		print(" [*] Facebook  : https://m.me/Tera.Bap.Ka.Id.Hain")
		print(" [*] Instagram : SHAHZADA-AHMED-SAJJAD --/n")
		print(" [*] Facebook  : https://m.me/Tera.Bap.Ka.Id.Hain")
		exit(" [*] GitHub    : https://github.com/SHAHZADA-AHMED ")
	else:
		Main()
